		...
		<div class="row" id="row4">
			<div class="main">
				...
				<div class="content">
					...
					<p>
					Upon successful verification of the transaction, you will receive a confirmation message that you've received a temporary VIP role in Oculus Lounge discord.
					</p>
					<p>
