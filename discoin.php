		...
		<div class="row" id="row4">
			<div class="main">
				...
				<div class="content">
					...
					<button class="button" type="button" onclick="checkTransaction();">Verify Transaction<img src="images/loading.gif" style="height: 28px;position: relative;left: 10px;top: 4px;"/></button>
					<p>
